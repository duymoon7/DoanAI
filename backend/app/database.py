...
# Construct PostgreSQL DATABASE_URL with explicit driver
...
logger.info(f"   Driver: postgresql+psycopg2")
logger.info(f"   URL: postgresql+psycopg2://{DB_USER}:***@{DB_HOST}:{DB_PORT}/{DB_NAME}")
...
def check_db_connection() -> bool:
    ...
    try:
        ...
        logger.error(f"   Check your .env file and ensure PostgreSQL is running")
        logger.error(f"   Database '{DB_NAME}' may not exist - run: python setup_db.py")
        return False
